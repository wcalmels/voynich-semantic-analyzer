...
The Voynich Manuscript has resisted definitive decipherment for more than a century. It consists of an unknown script accompanied by botanical, astronomical, balneological, pharmaceutical, and cosmological imagery. Although carbon dating places the vellum in the early 15th century, the manuscriptâ€™s iconographic and textual properties remain unresolved.

Foundational research by Currier, Friedman, Dâ€™Imperio, Landini, Takahashi, Stolfi, Zandbergen, and others demonstrated that Voynichese is not easily dismissed as random noise. Its token distribution, repetition patterns, internal structure, and folio-level variation suggest a system with linguistic-like regularities.
...
The DivriÄŸi Great Mosque and Hospital complex (1228â€“1229 CE) provides a historically plausible reference point for Anatolian medical culture. It should not be treated as a proven origin for MS 408, but rather as a contextual model for the type of medical, architectural, and pharmacological environment in which such knowledge could circulate.

Other plausible institutions include:

* Kayseri DarÃ¼ÅŸÅŸifa;
* Sivas DarÃ¼ÅŸÅŸifa;
* Konya medical institutions;
* broader Anatolian-Persian-Islamic medical networks.

Ibn al-Baytarâ€™s pharmacological tradition is also relevant because of its extensive plant-drug catalog and later circulation in Turkish-speaking Anatolian contexts.

Thus, the working hypothesis is not narrowly â€œDivriÄŸi produced the Voynich,â€ but more cautiously:

> The manuscriptâ€™s botanical, structural, and semantic features may be consistent with a broader Anatolian-Islamic medical knowledge environment.
...
| DivriÄŸi DarÃ¼ÅŸÅŸifa Hydrotherapy Fragment |                       0.4149 |
| Persian Medical Treatise                |                       0.4107 |
| Seljuk Herbal Fragment                  |                       0.3967 |
| Seljuk Womenâ€™s Medicine Fragment        |                       0.3876 |
...
# 16. Î¦47 Semantic Resonance Interpretation
...
This does not prove the manuscriptâ€™s origin, but it justifies deeper investigation using larger medieval corpora.
...
8. DivriÄŸi remains contextual, not documentary.
...
Dâ€™Imperio, M. (1978). The Voynich Manuscript: An Elegant Enigma. National Security Agency.
